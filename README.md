...
* `/ui`: Telas desenhadas no Qt Designer e seus arquivos `.py` gerados.
* `/controllers`: Classes com a lógica de funcionamento de cada tela.
* `main.py`: Arquivo inicial e enxuto para rodar a aplicação.
